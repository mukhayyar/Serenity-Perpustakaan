...
{
    [ConnectionKey("Perpustakaan"), Module("Perpustakaan"), TableName("pengembalian")]
    [DisplayName("Pengembalian"), InstanceName("Pengembalian")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript]
    public sealed class PengembalianRow : Row<PengembalianRow.RowFields>, IIdRow, IRow, IEntityWithJoins, IEntity, IHaveJoins
    {
        [DisplayName("Pengembalian Id"), Identity, IdProperty]
        public Int32? PengembalianId
        {
            get => fields.PengembalianId[this];
            set => fields.PengembalianId[this] = value;
        }

        [DisplayName("Tanggal Pengembalian")]
        public DateTime? TanggalPengembalian
        {
            get => fields.TanggalPengembalian[this];
            set => fields.TanggalPengembalian[this] = value;
        }
        ...
        [DisplayName("Buku"), NotNull, ForeignKey("buku", "BukuId"), LeftJoin("jBuku"), TextualField("BukuKodeBuku")]
        public Int32? BukuId
        {
        ...
        [DisplayName("Anggota"), NotNull, ForeignKey("anggota", "AnggotaId"), LeftJoin("jAnggota"), TextualField("AnggotaKodeAnggota")]
        ...
        [DisplayName("Petugas"), NotNull, ForeignKey("petugas", "PetugasId"), LeftJoin("jPetugas"), TextualField("PetugasNamaPetugas")]
        ...
        public PengembalianRow()
            : base()
        {
        }

        public PengembalianRow(RowFields fields)
            : base(fields)
        {
        }
        ...
        {
            public Int32Field PengembalianId;
            public DateTimeField TanggalPengembalian;

...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Perpustakaan
        {
            ...
            {
                public const string AnggotaIndex = "~/Modules/Perpustakaan/Anggota/AnggotaIndex.cshtml";
            }
            ...
            public static class Pengembalian
            {
                public const string PengembalianIndex = "~/Modules/Perpustakaan/Pengembalian/PengembalianIndex.cshtml";
            }

            public static class Petugas
            {
                public const string PetugasIndex = "~/Modules/Perpustakaan/Petugas/PetugasIndex.cshtml";
            }
